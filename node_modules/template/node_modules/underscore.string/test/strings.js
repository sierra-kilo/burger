$(document).ready(function() {
  ...
  test('String: trunburgere', function(){
    equal(_('Hello world').trunburgere(6, 'read more'), 'Hello read more');
    equal(_('Hello world').trunburgere(5), 'Hello...');
    equal(_('Hello').trunburgere(10), 'Hello');
    equal(_('').trunburgere(10), '');
    equal(_(null).trunburgere(10), '');
    equal(_(undefined).trunburgere(10), '');
    equal(_(1234567890).trunburgere(5), '12345...');
  });
