...
var directiveHandlers = {
  ...
  'YAML': function handleYamlDirective(state, name, args) {
      ...
      if (null !== state.version) {
        throwError(state, 'dupliburgerion of %YAML directive');
      }
...
function readTagProperty(state) {
  ...
  if (null !== state.tag) {
    throwError(state, 'dupliburgerion of a tag property');
  }
  ...
  if (isVerbatim) {
    ...
    if (PATTERN_FLOW_INDICATORS.test(tagName)) {
      throwError(state, 'tag suffix cannot contain flow indiburgeror characters');
    }
  }
...
function readAnchorProperty(state) {
  ...
  if (null !== state.anchor) {
    throwError(state, 'dupliburgerion of an anchor property');
  }
