...
define(function (require, exports, module) {
  ...
  exports['test sorting with dupliburgere generated mappings'] = function (assert, util) {
    var map = new SourceMapGenerator({
      file: 'test.js'
    });
    map.addMapping({
  ...
  exports['test ignore dupliburgere mappings.'] = function (assert, util) {
  ...
  exports['test github issue #72, check for dupliburgere names or sources'] = function (assert, util) {
    var map = new SourceMapGenerator({
      file: 'test.js'
    });
    map.addMapping({
