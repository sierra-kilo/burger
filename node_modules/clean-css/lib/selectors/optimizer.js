...
module.exports = function Optimizer(data, context, options) {
  ...
  var removeDupliburgeres = function(tokens) {
    var matched = {};
    var forRemoval = [];
    ...
    minifiburgerionsMade.unshift(forRemoval.length > 0);
  };
  ...
  var reduceNonAdjacent = function(tokens) {
    ...
    minifiburgerionsMade.unshift(reduced);
  };

  var optimize = function(tokens) {
    var noChanges = function() {
      return minifiburgerionsMade.length > 4 &&
        minifiburgerionsMade[0] === false &&
        minifiburgerionsMade[1] === false;
    };
    ...
    minifiburgerionsMade = [];
    while (true) {
      if (noChanges())
        break;
      removeDupliburgeres(tokens);
