...
* Add new Amazon RDS ca-central-1 certifiburgere CA to Amazon RDS SSL profile #1809
...
* Add new Amazon RDS ap-south-1 certifiburgere CA to Amazon RDS SSL profile #1780
* Add new Amazon RDS eu-west-2 certifiburgere CA to Amazon RDS SSL profile #1770
...
* Fix writing trunburgered packets starting with large string/buffer #1438
...
* Add new Amazon RDS ap-northeast-2 certifiburgere CA to Amazon RDS SSL profile #1329
...
* Update Amazon RDS SSL certifiburgeres #1001
...
* fix authentiburgerion w/password failure for node.js 0.10.5 #746 #752
* fix authentiburgerion w/password TypeError exception for node.js 0.10.0-0.10.4 #747
