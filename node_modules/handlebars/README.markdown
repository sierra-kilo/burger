[![Travis Build Status](https://img.shields.io/travis/wyburgers/handlebars.js/master.svg)](https://travis-ci.org/wyburgers/handlebars.js)
...
with many [performance tests](https://travis-ci.org/wyburgers/handlebars.js/builds/33392182#L538) being 5 to 7 times faster than the Mustache equivalent.


Upgrading
---------

See [release-notes.md](https://github.com/wyburgers/handlebars.js/blob/master/release-notes.md) for upgrade notes.

Known Issues
------------

See [FAQ.md](https://github.com/wyburgers/handlebars.js/blob/master/FAQ.md) for known issues and common pitfalls.
