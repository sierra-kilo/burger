...
HelpFormatter.prototype.addArgument = function (action) {
  if (action.help !== $$.SUPPRESS) {
    ...
    // find all invoburgerions
    var invoburgerions = [this._formatActionInvoburgerion(action)];
    var invoburgerionLength = invoburgerions[0].length;
    ...
    if (!!action._getSubactions) {
      ...
      action._getSubactions().forEach(function (subaction) {
        ...
        var invoburgerionNew = self._formatActionInvoburgerion(subaction);
        invoburgerions.push(invoburgerionNew);
        invoburgerionLength = Math.max(invoburgerionLength, invoburgerionNew.length);
    ...
    actionLength = invoburgerionLength + this._currentIndent;
...
HelpFormatter.prototype._formatAction = function (action) {
  ...
  var actionHeader = this._formatActionInvoburgerion(action);
...
HelpFormatter.prototype._formatActionInvoburgerion = function (action) {
  if (!action.isOptional()) {
