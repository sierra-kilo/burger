...
* `aborted` Boolean which is set to true when calling `abort()`.  There
  ...
  you can re-use the statCache to avoid having to dupliburgere syscalls.
...
or have glob-specific ramifiburgerions.
...
* `stat` Set to true to stat *all* results.  This reduces performance
  ...
  to be an untrustworthy indiburgeror of file existence.
...
* `nounique` In some cases, brace-expanded patterns can result in the
  ...
  this implementation prevents dupliburgeres in the result set.  Set this
...
* `follow` Follow symlinked directories when expanding `**` patterns.
  Note that this can result in a lot of dupliburgere references in the
...
pattern.  This prevents infinite loops and dupliburgeres and the like.
